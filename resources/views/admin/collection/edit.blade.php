    ...
    <div class="col s12">
        <div id="input-fields" class="card card-tabs">
            <div class="card-content">
                ...
                <form class="row" method="post" action="{{url('admin/collection/'.$collection->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col s12 input-field">
                        <label for="Name"> Name</label>
                        <input id="Name" name="name"  value="@if($errors->any()) {{ old('name')}} @else {{ $collection->name}} @endif" type="text" class="validate">
