            ...
            <form method="POST" action="{{url('admin/faq')}}">
                ...
                <div class="row mt-4">
                    ...
                    <div class="input-field col m12 s12">
                        <select class="form-select" name="faq_category_id" value="{{ old('faq_category_id') }}">
                            <option value="" disabled selected>Select Category</option>
                            @foreach ($faqCategory as $category)
                            <option @if(old('faq_category_id')==$category->id) selected @endif
                    ...
                    <div id="{{$item->name}}" class="col s12">
                        ...
                        <div class="input-field col m12 s12">
                            <input id="name{{$item->id}}" type="text" value="{{ old('question:'.$item->code) }}"
                                name="question:{{$item->code}}">
                        ...
                        <div class="input-field col m12 s12">
                            ...
                            <textarea  class="summernote mt-3" name="answer:{{$item->code}}">{{ old('answer:'.$item->code) }}</textarea>
                            <small class="errorTxt2">
