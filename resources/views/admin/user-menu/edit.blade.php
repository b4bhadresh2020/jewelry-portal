...
<div class="section">
    <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
            <div class="row">
                <div class="col s6">
                    <h4 class="card-title">Edit User Menu</h4>
                </div>
            ...
            <form method="POST" action="{{url('admin/user-menu')}}/{{ $userMenu->id }}" enctype="multipart/form-data">
                @csrf
                @method('put')
                @foreach ($findActiveLanguage as $item)
                    ...
                    @endif
                        <div class="input-field col m6 s12">
                            <input id="title{{$item->id}}" type="text" value="{{@$userMenu->translate(@$item->code)->title}}" name="title:{{$item->code}}">
                ...
                <div class="row ml-0">
                    ...
                    <div class="input-field col m6 s12">
                        <input id="link" type="text"  value="{{ $userMenu->link }}" name="link">
