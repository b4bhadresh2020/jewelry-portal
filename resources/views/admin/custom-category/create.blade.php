...
{{-- page title --}}
@section('title','Add New Custom Category')
{{-- page content --}}
@section('content')
<div class="section">
    <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
            ...
            <div class="row">
                <div class="col s6">
                    <h4 class="card-title">Create Custom Category</h4>
                </div>
            ...
            <form method="POST" action="{{url('admin/custom-category')}}" enctype="multipart/form-data">
                @csrf
