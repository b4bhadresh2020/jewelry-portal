            ...
            <form method="POST" action="{{ url('admin/category') }}/{{ $category->id }}" enctype="multipart/form-data">
                    ...
                    @foreach ($findActiveLanguage as $item)
                        <div id="{{$item->name}}" class="col s12 p-0">
                            <div class="input-field col m12 s12">
                                <input id="name{{$item->id}}" type="text" value="{{@$category->translate(@$item->code)->name}}"
                                    name="name:{{$item->code}}">
                            ...
                            <div class="input-field col m12 s12">
                                ...
                                <textarea  class="summernote mt-3" name="description:{{$item->code}}" >{{@$category->translate(@$item->code)->description}}</textarea>
                                <small class="errorTxt2">
                ...
                <div class="row">
                    ...
                    <div class="col m2 s12 file-field input-field">
                        <label>
                            <input type="checkbox"  name="offer_banner_visibility" value="1" @if(old('offer_banner_visibility')  || $category->offer_banner_visibility) {{ "checked"}} @endif/>
