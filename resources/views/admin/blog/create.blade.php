                ...
                <div class="row mt-4">
                    ...
                    <div id="{{$item->name}}" class="col s12">
                        ...
                        <div class="input-field col s12 row">
                            <textarea id="short_description{{$item->id}}"  class="materialize-textarea"  name="short_description:{{$item->code}}" >{{ old('short_description:'.$item->code) }}</textarea>
                        ...
                        <div class="input-field col m12 s12">
                            ...
                            <textarea  class="summernote mt-3" name="long_description:{{$item->code}}"
                                 >{{ old('long_description:'.$item->code) }}</textarea>
                            <small class="errorTxt2">
