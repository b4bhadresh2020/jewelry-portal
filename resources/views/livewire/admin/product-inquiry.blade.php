...
<div class="row">
    <div class="col s12">
        {{-- Load Filter--}}
        @include('admin.inquiryProduct.filter')
        <div class="card">
                                        ...
                                        @foreach ($inquiryInterface as $inquiry)
                                            <tr>
                                                ...
                                                @elseif($inquiry->status==3)
                                                    <td> <span class="chip red lighten-5"><span class="red-text">Close</span></span></td>
                                                @endif
                                                <td>
    ...
    <div id="modal1" class="modal" style="width: 45%; !imporatant;">
        <div class="modal-content">
            @if($defaultValue==1)
                <h5 class="mb-3">Product Inquiry</h5>
                <div class="row ml-1" >
                    <h6>Message</h6>
