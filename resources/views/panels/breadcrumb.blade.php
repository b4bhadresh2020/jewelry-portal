            ...
            <div class="col m12">
                ...
                <ol class="breadcrumbs mb-0">
                    ...
                    <li class="breadcrumb-item {{ !isset($breadcrumb['link']) ? 'active' :''}}">
                        ...
                        <a
                            href="{{url($breadcrumb['link'])}}">@endif{{$breadcrumb['name']}}@if(isset($breadcrumb['link']))</a>
                        @endif
                    </li>
                    @endforeach
                </ol>
            ...
            <div class="col s10 m6 l6 breadcrumbs-left">
                ...
                <ol class="breadcrumbs mb-0">
                    ...
                    <li class="breadcrumb-item {{ !isset($breadcrumb['link']) ? 'active' :''}}">
                        @if(isset($breadcrumb['link']) && ($breadcrumb['link'] !== 'javascript:void(0)'))
                        <a
                            href="{{$breadcrumb['link']}}">@endif{{$breadcrumb['name']}}@if(isset($breadcrumb['link']))</a>
                        @endif
                    </li>
                    @endforeach
                </ol>
            ...
            <div class="col s2 m6 l6"><a
                ...
                <ul class="dropdown-content" id="dropdown1" tabindex="0">
                    <li tabindex="0"><a class="grey-text text-darken-2"
                            href="{{asset('user-profile-page')}}">Profile<span class="new badge red">2</span></a></li>
                    <li tabindex="0"><a class="grey-text text-darken-2" href="{{asset('app-contacts')}}">Contacts</a>
                    </li>
