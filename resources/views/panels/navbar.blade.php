    ...
    <nav
        ...
        <div class="nav-wrapper">
            <div class="header-search-wrapper hide-on-med-and-down">
                ...
                <input class="header-search-input z-depth-2" type="text" name="Search" placeholder="Search Page" data-search="starter-kit-list">
                <ul class="search-list collection display-none" style="background: #fff;width: 100%;"></ul>
            </div>
                ...
                <li>
                    <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
                        ...
                        <span class="avatar-status avatar-online">
                            <img src="{{ userProfile(auth()->user()) }}" alt="avatar"><i></i>
                        </span>
                    </a>
                </li>
                {{-- <li>
            ...
            <ul class="dropdown-content" id="profile-dropdown">
                ...
                <li>
                    <a class="grey-text text-darken-1" href="{{url('logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
            ...
            <div class="nav-wrapper">
                <form id="navbarForm">
                    <div class="input-field search-input-sm">
                        <input class="search-box-sm mb-0" type="search" required="" placeholder='Search Page' id="search" data-search="starter-kit-list">
...
<!-- search ul  -->
<ul class="display-none" id="default-search-main"></ul>
