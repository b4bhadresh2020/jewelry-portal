...
class ContactInquiry extends Component
{
    ...
    public function render(InquiryContactRepositoryInterface $inquiryInterface, Request $request)
    {
        $request->merge([
        ...
        $this->viewMessageStatus = false;
        return view('livewire.admin.contact-inquiry',[
    ...
    public function viewMessage($inquiryId, InquiryContactRepositoryInterface $inquiryInterface)
    {
        $this->clearFilter();
    ...
    public function replyInquiry($inquiryId, InquiryContactRepositoryInterface $inquiryInterface)
    {
        $this->defaultValue=0;
        $inquiryContact             = $inquiryInterface->findById($inquiryId);
        $this->inquiryContact       = $inquiryContact;
