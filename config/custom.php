...
return [
    'custom' => [
        ...
        'templateTitle' => 'Shivaay', //template Title can be changes default('Materialize)
        'defaultLanguage' => 'en', //set your default language Options: en(default),pt,fr,de
        'largeScreenLogo' => 'default/materialize-logo-color.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'default/materialize-logo.png',  // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
        'direction' => env('MIX_CONTENT_DIRECTION', 'ltr'),
        'secure_url' => env('SECURE_URL', true),
    ],
    'world_addresses' => [
        'countries' => [
            'key'  => 'Country',
